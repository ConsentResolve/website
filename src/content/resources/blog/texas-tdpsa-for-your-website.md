...
slug: "texas-tdpsa-for-your-website"
resource_type: "blog"
status: "published"
author: "Andy Mentges"
...
faq_items:
  - question: "Does the Texas TDPSA apply to my small contracting business?"
    answer: "Quite possibly. Unlike California's privacy law, the TDPSA has no revenue or volume threshold that exempts small businesses — it turns on whether you handle Texans' personal data and aren't a recognized small business under the SBA definition selling data. The safe assumption for a website that collects visitor data is that the law's core duties apply, so build for them."
...
That's where the enforcement record gets your attention, not as a forecast for your shop but as proof Texas means it. In January 2025, the state filed the [first-ever enforcement suit](https://www.texasattorneygeneral.gov/news/releases/attorney-general-ken-paxton-sues-allstate-and-arity-unlawfully-collecting-using-and-selling-over-45) under a comprehensive state data-privacy law — over driving data collected and sold without consent. And Texas had already shown it would swing hard on [consent](/resources/glossary/#consent): a [$1.4 billion settlement with Meta](https://www.texasattorneygeneral.gov/news/releases/attorney-general-ken-paxton-secures-14-billion-settlement-meta-over-its-unauthorized-capture) over biometric data captured without permission, and a [$1.375 billion settlement with Google](https://www.texasattorneygeneral.gov/news/releases/attorney-general-ken-paxton-secures-historic-1375-billion-settlement-google-related-texans-data) over tracking Texans without consent. Those are the largest privacy settlements a single state has ever obtained. The common thread in every one is the same word the TDPSA is built around: consent.
