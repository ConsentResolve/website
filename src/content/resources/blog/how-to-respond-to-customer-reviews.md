---
title: "How to Respond to Customer Reviews — Including the Bad One"
slug: "how-to-respond-to-customer-reviews"
resource_type: "blog"
status: "published"
...
faq_items:
  - question: "Should I respond to every review, even the short positive ones?"
    answer: "Yes. A quick, warm reply to a positive review shows the next reader that a real person runs the business and pays attention. It costs a minute and makes your whole page read as active and cared-for. A page full of five-stars with zero replies looks abandoned by comparison."
  - question: "How do I respond to a bad review without making it worse?"
    answer: "Stay calm, don't argue the facts in public, and don't get defensive. Acknowledge their experience, apologize for the frustration, and offer to make it right offline with a name and a way to reach you. The reply isn't to win with that customer — it's to show every future reader that you own problems instead of hiding from them."
  - question: "Doesn't one bad review hurt my reputation?"
    answer: "A single negative review among genuine positive ones rarely hurts, and a well-handled one can help — it proves your reviews are real and shows how you act when something goes sideways. Since positive reviews sway about 91% of buyers, a body of good reviews with a calm, accountable reply to the rare bad one reads as trustworthy, not perfect."
sources:
...
Start with the simplest win: replying makes you look present. [4 in 5 people use search to find local businesses](https://www.brightlocal.com/resources/local-seo-statistics/), so your review page is a storefront strangers walk past constantly. A page where the owner answers reviews reads as a real, active shop that pays attention. A page of silent five-stars — even good ones — reads as abandoned, or automated, or a business that's checked out.

And since [positive reviews sway about 91% of buyers](https://www.brightlocal.com/research/local-consumer-review-survey/), you want every one of those positive reviews to land as credibly as possible. A short, specific reply makes the review feel real and reminds the reader there's a human back there who cared enough to say thanks.
