...
primary_cta:
  label: "See how consent-first retargeting works →"
  url: "https://consentresolve.com/features/instant-retarget/"
secondary_cta:
  label: "Read: What is consent-first marketing?"
  url: "/resources/plain-language-explainers/what-is-consent-first-marketing/"
faq_items:
  - question: "Is retargeting legal for a home-service business?"
    answer: "Yes. Showing ads to people who visited your site is legal. The legal risk isn't the ads — it's how the audience gets built. Most retargeting relies on tracking pixels that collect a visitor's data without asking, and that collection is what state privacy laws increasingly treat as a violation."
  - question: "Which laws apply to retargeting pixels?"
    answer: "The main ones are state privacy and wiretapping laws — California's CIPA and CCPA, and Texas's TDPSA — which govern collecting and sharing a visitor's data without disclosure and consent. The TCPA covers calls and texts, which is a separate reason consent-first follow-up stays email-grade, never a cold call."
  - question: "How does consent-first retargeting lower the risk?"
    answer: "The audience is built only from visitors who accept a clear, visible consent banner, and each consent is logged with a timestamp and held in a 7-year audit trail. If anyone ever asks how you got a contact, you have the record. Covert pixels can't produce that."
  - question: "Do I have to stop retargeting to stay compliant?"
    answer: "No. You have to change how the audience is built — from silent tracking to explicit consent. You keep retargeting past visitors on the ad accounts you already run; you just do it with people who agreed to be reached and a record proving it."
---
...
- **The [TCPA](https://www.law.cornell.edu/uscode/text/47/227)** governs calls and texts, not pixels — but it's the same principle, and it's the reason consent-first follow-up stays email-grade. You don't get a phone number to cold-call, because a cold call to someone who never opted in is its own liability.
...
With [consent-first retargeting](/features/instant-retarget/), the audience is built **only** from visitors who see a clear, visible consent banner and accept it. Before that yes, nobody is tagged and nothing is added. After it, that visitor becomes a consented member of your audience — and the moment is logged with a timestamp and held in a 7-year audit trail.

That record is the whole difference. If a regulator, a plaintiff's lawyer, or an ad platform ever asks how you obtained a contact, you can answer with a date and a documented consent. A covert pixel has no answer to that question, because the entire point of a covert pixel is that nobody was asked. [Consent-first marketing](/resources/plain-language-explainers/what-is-consent-first-marketing/) isn't a slower way to do the same thing — it's the version that holds up when someone checks.
