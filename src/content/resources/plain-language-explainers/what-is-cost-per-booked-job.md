---
title: "What Is Cost Per Booked Job?"
...
seo_title: "What Is Cost Per Booked Job? The Number That Actually Matters"
seo_description: "Cost per booked job is what you pay for one lead that actually becomes work. Here's how to calculate it, why it beats cost per lead, and how to track it by source."
...
tags: ["cost per booked job", "cost per lead", "marketing metrics", "roi", "lead generation"]
funnel_stage: "convert"
schema_type: "Article"
tldr: "Cost per booked job is the amount you pay to land one lead that actually turns into work. You calculate it by dividing total spend by the number of booked jobs. It's the honest version of cost per lead, because it counts only the leads that paid off — and it's the number that tells you if a channel really makes you money."
key_takeaways: "Cost per booked job is total spend divided by jobs you actually booked, not leads you collected. It's the honest unit because it folds in your close rate — cheap leads that never book make this number ugly fast. Two channels with the same cost per lead can have wildly different costs per booked job depending on lead quality. Track it by source so you fund the channels that produce paying work. This is the number to compare against the value of a customer when deciding what to spend."
glossary_slug: "cost-per-booked-job"
related:
  - label: "Glossary: Cost Per Booked Job"
...
faq_items:
  - question: "How do I calculate cost per booked job?"
    answer: "Add up everything you spent on a channel, then divide by the number of jobs you actually booked from it. If you spent $2,000 and booked 8 jobs, your cost per booked job is $2,000 ÷ 8 = $250."
  - question: "Why is cost per booked job better than cost per lead?"
    answer: "Cost per lead counts every lead, even the ones that never answer or never hire you. Cost per booked job counts only the leads that became real work, so it bakes in your close rate. It tells you what you actually pay for revenue, which is the number that decides if a channel is worth it."
  - question: "How is cost per booked job different from customer acquisition cost?"
