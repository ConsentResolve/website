...
tags: ["google business profile", "local seo", "google maps", "map pack", "home services"]
funnel_stage: "get-found"
schema_type: "Article"
tldr: "A Google Business Profile (GBP) is the free listing Google gives your business so it can show up on Google Search and Google Maps. It holds your name, phone, address or service area, hours, reviews, and photos — and it's the single biggest factor in whether local customers find you when they search for your trade."
key_takeaways: "A Google Business Profile is the free listing that puts your business on Google Search and Maps. It controls what customers see when they search your trade plus their town — name, phone, hours, reviews, and photos. Claiming and verifying it is free and takes a few minutes. Keeping it accurate and full of recent reviews is what gets you into the Map Pack, the three listings shown above the regular results."
...
The payoff is the **Map Pack**: the group of three business listings Google shows at the top, above the normal blue links, with the little map beside them. Most local clicks and calls go to those three spots, so getting into them is the whole game for local trades. There's a full walkthrough in our guide on how to [rank in the Google Map Pack for home services](/resources/how-to-guides/rank-google-map-pack-home-services/).
