...
seo_description: "Cost per lead is what you pay for one new lead. Here's how to calculate CPL, why it can mislead contractors, and the number that matters more"
...
schema_type: "Article"
tldr: "Cost per lead (CPL) is the average amount you pay to get one new lead. You calculate it by dividing total spend by the number of leads you got. It's a useful starting number, but a cheap lead that never books a job costs you more than an expensive one that does — so always pair CPL with cost per booked job."
key_takeaways: "Cost per lead is total spend divided by total leads, and it tells you what one lead costs on average. A low CPL looks good but means nothing if the leads don't turn into paying jobs. Shared leads and bought lists often have a low sticker price and a high real cost once you factor in close rate. The honest number is cost per booked job — what you actually pay for work that pays you back. Track CPL by source so you can see which channels send leads that close."
glossary_slug: "cost-per-lead-cpl"
related:
  - label: "Glossary: Cost Per Lead (CPL)"
    url: "/resources/glossary/#cost-per-lead-cpl"
  - label: "What Is Cost Per Booked Job?"
...
primary_cta:
  label: "See flat $7-per-lead pricing →"
...
faq_items:
  ...
  - question: "What is a good cost per lead for contractors?"
    answer: "There's no single right number — it depends on your trade, your average job value, and how many leads you close. A $50 lead is cheap if you close half of them and great if your average job is several thousand dollars. Judge CPL against cost per booked job, not on its own."
...
| **Formula** | Spend ÷ leads | Spend ÷ booked jobs |
