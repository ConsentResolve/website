...
seo_title: "What Are Google Local Services Ads (LSA)?"
seo_description: "Google Local Services Ads put home-service contractors at the top of search with a Google Guaranteed badge. Here's how they work, what they cost"
focus_keyword: "what are google local services ads"
canonical_url: "https://consentresolve.com/resources/plain-language-explainers/what-are-google-local-services-ads/"
category: "Marketing Channels"
tags: ["local services ads", "lsa", "google guaranteed", "lead generation", "home services"]
funnel_stage: "get-found"
schema_type: "Article"
tldr: "Google Local Services Ads (LSAs) are pay-per-lead ads that sit at the very top of Google search results for home-service searches. You pass a screening and background check to earn the Google Guaranteed badge, then pay only when a customer contacts you through the ad — not for clicks."
key_takeaways: "Local Services Ads run above regular Google Ads and the map pack, and you pay per lead instead of per click. To run them you have to pass Google's screening and background check, which earns the Google Guaranteed badge. You can dispute and get credited for leads that aren't a real fit. LSAs are strong for booked jobs, but the leads are shared — Google sends the same searcher to several contractors at once, so speed of response matters."
glossary_slug: "local-services-ads-lsa"
related:
  - label: "Glossary: Local Services Ads (LSA)"
    url: "/resources/glossary/#local-services-ads-lsa"
  ...
  - label: "How to Win at Google Local Services Ads"
    url: "/resources/how-to-guides/win-google-local-service-ads/"
primary_cta:
  label: "See how consented leads work →"
  url: "https://consentresolve.com/"
faq_items:
  - question: "How much do Google Local Services Ads cost?"
    answer: "You pay per lead, not per click, and the price per lead varies by trade and area. You set a weekly budget, and Google bills you only when a customer calls or messages you through the ad. Leads that clearly aren't a fit can be disputed for a credit."
  - question: "What is the Google Guaranteed badge?"
    answer: "It's the green checkmark badge you earn after passing Google's screening and background check. For eligible trades it also backs the customer with a limited guarantee, which makes the ad more trustworthy and helps it stand out."
  - question: "Are Local Services Ads leads exclusive to me?"
...
| Feature | Local Services Ads (LSA) | Google Ads (PPC) |
| --- | --- | --- |
| You pay for | A lead (call or message) | A click |
| Position on page | Very top, above everything | Below the LSA block |
| Screening required | Yes — license, insurance, background check | No |
| Google Guaranteed badge | Yes | No |
| Leads shared with competitors | Usually | Depends on your landing page and follow-up |
| Best for | Booked service jobs | Broader campaigns and website traffic |
...
## How LSAs fit a consent-first approach
