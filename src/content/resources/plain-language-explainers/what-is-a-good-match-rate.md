---
title: "What Is a Good Match Rate?"
slug: "what-is-a-good-match-rate"
...
seo_title: "What Is a Good Match Rate?"
seo_description: "Match rate is the share of website visitors a service can identify. Here's what a realistic number looks like, why a sky-high rate is a red flag"
focus_keyword: "what is a good match rate"
canonical_url: "https://consentresolve.com/resources/plain-language-explainers/what-is-a-good-match-rate/"
category: "Visitor Identification"
tags: ["match rate", "visitor identification", "identity resolution", "consent", "lead quality"]
funnel_stage: "convert"
schema_type: "Article"
tldr: "A match rate is the share of your website visitors that an identification service can connect to a real person or business. A 'good' rate depends on the method: a consent-based service will report a modest single-digit-to-low-double-digit percentage, because it only counts visitors who agreed to be identified — and that low number is a feature, not a flaw."
key_takeaways: "Match rate is the percentage of visitors a service can identify, but the number means nothing without knowing how it was reached. Consent-based services report lower rates because they only count people who agreed to be identified. A 90%+ rate usually means the provider is de-anonymizing everyone, which is the risky approach. Judge a service by lead quality and how consent was collected, not by chasing the highest match rate."
glossary_slug: "match-rate"
related:
  - label: "Glossary: Match Rate"
    url: "/resources/glossary/#match-rate"
  ...
  - label: "What Are Anonymous Website Visitors?"
    url: "/resources/plain-language-explainers/what-are-anonymous-website-visitors/"
...
faq_items:
  - question: "What's a realistic match rate?"
    answer: "For a consent-based service, expect a modest number — often in the single digits to low double digits as a share of total visitors. That's because the service only counts visitors who actually agreed to be identified, which is a small slice of any audience."
  - question: "Why would a low match rate be good?"
    answer: "A low rate means the service is being honest about consent. It's only surfacing people who said yes, not everyone who happened to load your page. A higher rate usually means the provider relaxed the consent standard to inflate the number."
  - question: "Is a 90% match rate possible?"
