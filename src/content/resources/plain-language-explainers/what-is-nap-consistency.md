...
key_takeaways: "NAP stands for Name, Address, and Phone number. Consistency means they read identically everywhere your business appears online. Mismatches — old phone numbers, abbreviations, a former address — make Google less confident you're one real business, which can lower your local ranking. The fix is unglamorous but powerful: pick one exact format and clean up every listing to match it."
glossary_slug: "nap"
related:
  - label: "Glossary: NAP"
    url: "/resources/glossary/#nap"
...
faq_items:
  - question: "What does NAP stand for?"
    answer: "Name, Address, and Phone number. NAP consistency means those three pieces of information are written exactly the same way everywhere your business appears online — same spelling, same format, same number."
  - question: "Does a small difference in my address really matter?"
    answer: "Small differences add up. 'Suite 200' on one site and 'Ste 200' on another, or an old phone number lingering in an old directory, can make Google less certain you're a single real business. Matching exactly removes that doubt."
  - question: "Where do I need my NAP to match?"
