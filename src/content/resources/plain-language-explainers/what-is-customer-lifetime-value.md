...
seo_title: "What Is Customer Lifetime Value (LTV)?"
seo_description: "Customer lifetime value is the total profit one customer brings over the years they stay with you. Here's how to estimate LTV and use it to decide what a"
focus_keyword: "what is customer lifetime value"
canonical_url: "https://consentresolve.com/resources/plain-language-explainers/what-is-customer-lifetime-value/"
category: "Metrics & ROI"
tags: ["customer lifetime value", "ltv", "marketing metrics", "roi", "customer retention"]
funnel_stage: "convert"
schema_type: "Article"
tldr: "Customer lifetime value (LTV) is the total profit one customer brings over the whole time they stay with you — repeat jobs, referrals, and all. You estimate it from average job value, how often they come back, and how long they stick around. Knowing LTV tells you how much you can afford to spend to win a customer."
key_takeaways: "Customer lifetime value is the total profit one customer brings across every job they ever give you, not just the first one. You estimate it from average job value, repeat frequency, and how many years a customer stays. A higher LTV means you can afford to spend more to win each customer and still come out ahead. The real power of LTV is the ratio against acquisition cost — that's what tells you if your growth is profitable. Even a rough LTV estimate beats treating every customer like a one-time sale."
glossary_slug: "lifetime-value-ltv"
related:
  - label: "Glossary: Lifetime Value (LTV)"
    url: "/resources/glossary/#lifetime-value-ltv"
  - label: "What Is Customer Acquisition Cost (CAC)?"
    url: "/resources/plain-language-explainers/what-is-customer-acquisition-cost/"
  - label: "What Is ROAS (Return on Ad Spend)?"
    url: "/resources/plain-language-explainers/what-is-roas/"
...
faq_items:
  - question: "How do I calculate customer lifetime value?"
    answer: "A simple version: average job value × jobs per year × number of years a customer stays, then take the profit portion. If a customer spends $600 a year for 5 years and your margin is 40%, that's $600 × 5 × 0.40 = $1,200 in lifetime value."
  - question: "Why does lifetime value matter if I do one-time jobs?"
    answer: "Even one-time jobs lead to referrals and reviews, which bring new customers at little cost. And many 'one-time' trades see customers come back years later or recommend you to neighbors. Estimating LTV keeps you from underpaying for leads because you only counted the first job."
  - question: "What's the difference between LTV and average job value?"
