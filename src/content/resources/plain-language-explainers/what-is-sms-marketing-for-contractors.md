...
faq_items:
  - question: "Do I need permission to text a customer?"
    answer: "For marketing texts, yes — you need clear prior consent from the person before you send. A customer giving you their number to schedule a job isn't the same as agreeing to receive promotional texts. Marketing messages need their own opt-in, and texting numbers that didn't agree carries real legal exposure."
  - question: "What has to be in a marketing text?"
    answer: "Identify your business so it's clear who's texting, send only to people who opted in, and include an easy way to opt out — usually 'Reply STOP to unsubscribe.' When someone replies STOP, the texts have to end immediately."
...
## How SMS fits a consent-first approach
