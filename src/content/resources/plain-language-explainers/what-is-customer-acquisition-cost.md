...
seo_title: "What Is Customer Acquisition Cost (CAC)?"
seo_description: "Customer acquisition cost is what you spend to win one new customer. Here's how to calculate CAC, what counts, and how to read it against the value of a"
focus_keyword: "what is customer acquisition cost"
canonical_url: "https://consentresolve.com/resources/plain-language-explainers/what-is-customer-acquisition-cost/"
category: "Metrics & ROI"
tags: ["customer acquisition cost", "cac", "marketing metrics", "roi", "lead generation"]
funnel_stage: "convert"
schema_type: "Article"
tldr: "Customer acquisition cost (CAC) is the total amount you spend on marketing and sales to win one new customer. You calculate it by dividing total spend by the number of customers you gained. On its own it's just a cost — it only means something when you compare it to what a customer is worth to you."
key_takeaways: "Customer acquisition cost is total sales and marketing spend divided by new customers won. It's broader than cost per lead because it counts everything it takes to turn interest into a paying customer. A high CAC isn't bad if each customer is worth far more than it cost to win them. The number to compare it against is customer lifetime value — that ratio tells you whether your growth is profitable. Track CAC by channel so you stop feeding the ones that cost too much per customer."
glossary_slug: "customer-acquisition-cost-cac"
related:
  - label: "Glossary: Customer Acquisition Cost (CAC)"
    url: "/resources/glossary/#customer-acquisition-cost-cac"
...
faq_items:
  - question: "How do I calculate customer acquisition cost?"
    answer: "Add up everything you spent winning customers over a period — ads, lead fees, software, and the cost of the time spent selling — then divide by the number of new customers you gained. If you spent $4,000 and won 10 customers, your CAC is $400."
  - question: "What's the difference between CAC and cost per lead?"
    answer: "Cost per lead is what you pay for a lead. CAC is what you pay for a customer — a lead that actually bought. CAC is always higher because not every lead becomes a customer, and it counts sales effort, not just marketing spend."
