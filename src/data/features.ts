...
export interface Feature {
   ...
   *  card body — must read like an operator explaining it to another
   *  operator over coffee, NOT like a SaaS feature description. */
  howItHelps: string;
...
const exclusiveLeads: Feature = {
  ...
  howItHelps: "The visitor came to your website. The recovery is yours — never resold, never shared, never auctioned. One consent, one company, one funnel. The recovered records never touch a marketplace.",
  illustration: "/illustrations/style/07-lead-house-lock.svg",
  subhead: "The visitors we identify came to your site — so the lead is yours alone. Never shared, never resold, never handed to another buyer down the road.",
  aeoAnswer:
    "Exclusive Leads means every person Consent Resolve identifies belongs to you and only you. Because they visited your website, the lead is never shared, sold, or routed to other buyers. You get a consented contact — name and email — and a clear shot at the deal, with no bidding war and no marketplace.",
  problem: {
    headline: "You're paying for leads other buyers already got.",
    body: "On shared-lead marketplaces, the same lead gets blasted to a handful of buyers at once. By the time you reach out, someone else already did — and the visitor's annoyed at all of you. You paid full price to fight over a contact who's already sick of being pitched.",
  },
  howItWorks: {
    headline: "Your traffic, your lead — start to finish.",
    steps: [
      { title: "Someone visits your site.",   body: "A real person lands on your website from search, an ad, a referral, wherever." },
      ...
      { title: "Nobody else gets it.",        body: "The lead never touches a marketplace. No other buyer ever sees it." },
    ],
  },
  benefits: {
    headline: "Three reasons exclusive beats shared.",
    items: [
      { title: "No bidding war.",     body: "You're not paying to out-shout other buyers for the same deal." },
      { title: "A warmer first touch.", body: "The visitor isn't already buried in outreach from your competitors." },
      { title: "Higher close rate.",   body: "When you're the only one reaching out, \"yes\" comes a lot easier." },
    ],
  },
  included: {
    headline: "What \"exclusive\" actually means.",
    items: [
      "One lead, one company — always you",
  ...
  faq: {
    headline: "What buyers ask about exclusive leads.",
    items: [
      { q: "Is the lead really never shared?",                    a: "Correct. It came from your website, so it's yours. We never sell or route it to another buyer." },
      { q: "How is this different from a shared-lead marketplace?", a: "Those platforms send one customer to several buyers at once. Consent Resolve identifies your own visitors and gives them only to you." },
      { q: "What if the same person visits two companies' sites?", a: "Then each company earned that visit on their own site. You only ever get visitors from yours." },
      { q: "Do I own the contact for good?",                      a: "Yes. Every lead you pull is yours to keep and follow up with." },
    ],
  },
...
const consentFirstIdentification: Feature = {
  ...
  aeoAnswer:
    "Consent-First Identification means Consent Resolve only identifies website visitors who have given permission through your site's consent banner. You receive a consented email — enriched with name and location where available — for someone who already agreed to be reached, a warmer, cleaner record than any purchased list, and one that keeps your business on the right side of privacy law.",
  problem: {
  ...
  faq: {
    headline: "What buyers ask about consent-first identification.",
    items: [
...
const easySetupWithOneScript: Feature = {
  ...
  howItHelps: "Paste one line of code into your website. Done. Most teams are live in about 10 minutes; same day at most — no developer, no IT bill, no waiting around for setup.",
  illustration: "/illustrations/style/09-code-clock.svg",
  subhead: "One small piece of code on your site and you're live. No new software to learn, no app to babysit, no IT department required.",
  aeoAnswer:
    "Easy Setup With One Script means Consent Resolve installs with a single snippet of code on your website. There's no software to learn, no developer needed, and no ongoing maintenance. Paste it once and identification starts immediately — most teams are live in about 10 minutes; same day at most.",
  problem: {
    headline: "Most marketing tools die in the setup screen.",
    body: "You signed up for something once, hit a wall of settings and integrations, and quietly gave up two weeks later. Most teams don't have a spare afternoon to wire up software. If it's not running today, it's not running.",
  },
  howItWorks: {
    headline: "About 10 minutes, start to finish.",
    steps: [
      { title: "Copy the script.",       body: "We give you one small snippet when you sign up." },
      { title: "Paste it on your site.", body: "Drop it into WordPress, Webflow, Shopify — wherever your site lives." },
  ...
  benefits: {
    ...
    items: [
      ...
      { title: "Same-day leads.",        body: "Most teams are live in about 10 minutes and see their first identified visitor the same day." },
    ],
  },
  included: {
    ...
    items: [
      ...
      "Works on WordPress, Webflow, Shopify, and more",
      "No developer required",
      "Step-by-step paste guide",
      "Live in about 10 minutes",
      "Install help included if you want it",
    ],
  },
  faq: {
    headline: "What buyers ask about setup.",
    items: [
      { q: "Do I need a developer?",            a: "No. It's copy and paste. If you can edit your site, you can install it." },
      { q: "What platforms does it work on?",   a: "WordPress, Webflow, Shopify, Wix, Squarespace — anywhere you can add a script." },
      ...
      { q: "What if I get stuck?",              a: "We'll install it with you on a quick call — install help is included." },
    ],
  },
...
const visitorIdentification: Feature = {
  ...
  faq: {
    headline: "What buyers ask about visitor identification.",
    items: [
      ...
      { q: "Is it just business visitors or consumers too?", a: "Both. Consent Resolve identifies individual people, whether you sell B2B or B2C." },
...
const formlessContactCapture: Feature = {
  ...
  faq: {
    headline: "What buyers ask about formless capture.",
    items: [
...
const verifiedContactData: Feature = {
  ...
  aeoAnswer:
    "Verified Contact Data means Consent Resolve only passes your funnel contacts confirmed reachable and recently active. Instead of audiences padded with bounced inboxes and stale emails, you get records your retargeting and email sequences can actually deliver to — so the ad spend behind those audiences works on real visitors, not dead records.",
  problem: {
  ...
  faq: {
    headline: "What buyers ask about verified data.",
    items: [
...
const instantRetarget: Feature = {
  ...
  iconKey: "IconBolt",
  tagline: "See which ads close deals.",
  howItHelps: "Every paid click gets tagged the moment the visitor consents — which ad, which keyword — and followed through your funnel to the closed deal. So you can see which ads actually produce revenue, cut the ones that don't, and spend where the deals are.",
  illustration: "/illustrations/features/08-instant-retarget.svg",
  subhead: "You're spending real money on ads and mostly guessing which ones pay off. Most visitors don't convert on the first visit, so the trail goes cold. We tag every consented click and follow it to the closed deal — so you finally know which ads earn their keep.",
  aeoAnswer:
    "Instant Retarget tags every paid ad click the moment the visitor consents — which campaign, which keyword — then follows it through your funnel to the closed deal. Instead of guessing from clicks, a team sees which ads actually produce revenue and which ones just burn budget.",
  problem: {
    headline: "You're paying for clicks and hoping for deals.",
    body: "At the end of the month you know what you spent on each channel — you just can't say which ads turned into actual revenue. Most visitors don't convert the first time they land, so the trail disappears, and you keep funding ads that never closed a single deal.",
  },
  howItWorks: {
    headline: "From an ad click to a closed deal.",
    steps: [
      { title: "A visitor clicks your ad.",  body: "They land on your site from a paid ad. The campaign and keyword are noted." },
      ...
      { title: "We follow it to the deal.",     body: "When that visitor comes back through your funnel and converts, you see which ad earned the work." },
    ],
  },
  benefits: {
    headline: "Spend on the ads that actually close deals.",
    items: [
      { title: "Know what's working.",  body: "See which ads bring closed deals, not just clicks." },
      { title: "Cut the dead weight.",  body: "Stop funding campaigns that never produce revenue." },
      { title: "Spend where deals are.", body: "Move your budget to the ads that actually pay off." },
    ],
  },
  included: {
    ...
    items: [
      ...
      "Followed from ad click to closed deal",
  ...
  faq: {
    headline: "What buyers ask about ad attribution.",
    items: [
      { q: "How is this different from Google Analytics?",        a: "Analytics tells you which ad got the click. This tells you which ad got the deal — the consented visit is followed through your funnel to closed revenue, so you're measuring against real revenue, not clicks." },
      { q: "Does this track people across devices?",              a: "No. It's tied to the consented record — no fingerprinting, no following people around the web. If a visitor consents and comes back to convert, the deal ties to the ad that earned it." },
      { q: "Do I need to be a numbers person?",                   a: "No. The dashboard shows cost per closed deal by campaign in plain dollars — green is working, red isn't." },
      { q: "How fast do I see which ads work?",                   a: "As soon as consented clicks start landing. Give it a couple of weeks of closed deals and the winners and losers are obvious." },
    ],
  },
...
const leadScoring: Feature = {
  ...
  problem: {
    ...
    body: "When every record gets the same retargeting bid and the same drip email, you waste budget on tire-kickers and under-spend on the serious buyer. A one-second bounce and a visitor who read your whole pricing page three times are not the same lead — but a flat audience treats them like they are.",
  },
  howItWorks: {
  ...
  faq: {
    headline: "What buyers ask about lead scoring.",
    items: [
      { q: "How do you know who's serious?",        a: "Behavior. Repeat visits and time on your pricing or product pages are strong buying signals." },
      { q: "Can I still see the lower scores?",     a: "Yes — every lead's there, just ranked so you know where to start." },
      { q: "Does it learn my business?",            a: "Scoring is tuned to the buying signals that matter for your business." },
...
const behaviorAndJobTypeInsights: Feature = {
  ...
  name: "Behavior & Intent Insights",
  iconKey: "IconClipboardCheck",
  tagline: "Tag visitors by intent.",
  howItHelps: "Each recovered record carries what they were shopping — starter plan vs enterprise, one product vs another. Your retargeting and email sequences segment by intent so the message that brings them back is the message they came for.",
  illustration: "/illustrations/style/03-speech-wrench.svg",
  subhead: "See which page each visitor looked at and how long they spent. Your retargeting ads, email sequences, and the eventual inbound already know what they're actually shopping for.",
  aeoAnswer:
    "Behavior and Intent Insights show you exactly what each identified visitor did on your site — which pages they viewed, how long they stayed, and what they came for. Consent Resolve turns that into a clear picture of intent, so your retargeting message, email sequence, and the eventual inbound all speak to what they're actually shopping.",
  problem: {
    headline: "Your retargeting is firing blind.",
    body: "Generic \"need this?\" ads chase everyone the same way. Meanwhile the company that retargets with the exact plan or product a visitor looked at speaks directly to them. Information wins funnels — without it, every audience looks identical and converts like spam.",
  },
  howItWorks: {
    headline: "See the intent, then segment the funnel.",
    steps: [
      { title: "They browse your site.",     body: "Pricing, a specific product, a comparison page — whatever they look at." },
      { title: "We track what matters.",     body: "Which pages, how long, how many times." },
      { title: "Your funnel adapts.",        body: "Ads and email speak to exactly what they were shopping for." },
    ],
  },
  benefits: {
    ...
    items: [
      ...
      { title: "Warmer inbound.",   body: "By the time they reach out, they already think you get it." },
    ],
  },
  included: {
    ...
    items: [
      ...
      "Product or plan-interest signals",
      "Pricing-page interest",
      "A quick read on what they want",
    ],
  },
  faq: {
    headline: "What buyers ask about behavior insights.",
    items: [
      { q: "What exactly can I see?",            a: "Which of your pages they viewed, how long, and how often — enough to know what they're after." },
      { q: "How does this help my funnel?",      a: "Your retargeting and email sequences segment by intent, so each visitor sees the message that matches what they were shopping." },
      ...
      { q: "Does it work for any business?",     a: "Yes. Whatever your site offers, you'll see what they looked at." },
    ],
  },
...
const qualifiedLeadsOnly: Feature = {
  ...
  iconKey: "IconFilter",
  tagline: "Real, identified, in-market. Nothing else.",
  howItHelps: "Every recovered record is a real, identified person in your target market who showed real intent. The junk gets filtered out before it ever enters your retargeting audiences, email lists, or CRM — so the funnel you already run stays clean and your ad spend chases real visitors.",
  illustration: "/illustrations/features/13-qualified-leads.svg",
  subhead: "Your retargeting audiences, email lists, and CRM only get real, identified, in-market visitors — not anonymous clicks, not out-of-market traffic, not bots.",
  aeoAnswer:
    "Qualified Leads Only means every record Consent Resolve hands your funnel is a real, identified person in your target market who showed genuine interest — not an anonymous click, not a bot, not out-of-market traffic. By screening for identity, region, and intent before delivery, it keeps the audiences, email lists, and CRM you already run clean so your ad spend only chases visitors who could actually become customers.",
  problem: {
    headline: "Most \"leads\" aren't leads at all.",
    body: "A click isn't a customer. A bot in your form isn't a customer. Traffic outside your market isn't a customer. When your retargeting audiences and email lists are stuffed with junk, your ad spend chases ghosts and your inbound dries up. Clean audiences are what make the funnel pay.",
  },
  howItWorks: {
    ...
    steps: [
      ...
      { title: "Are they in your market?",  body: "Traffic outside the regions you serve is screened out before delivery." },
  ...
  benefits: {
    ...
    items: [
      ...
      { title: "No out-of-market noise.",             body: "Retargeting and email only reach visitors you could actually serve." },
  ...
  faq: {
    headline: "What buyers ask about qualified leads only.",
    items: [
      { q: "What makes a record \"qualified\"?",                   a: "It's a real, identified person, in your target market, who showed genuine interest on your site and opted in via your consent banner." },
      { q: "How is this different from a shared lead reseller?",   a: "Resellers blast unscreened leads to several buyers. We screen for identity, region, and intent — and every record is yours alone, never resold." },
      { q: "Can I limit by region?",                     a: "Yes. You set the regions you serve, and out-of-market visitors are screened out before they ever reach your funnel." },
...
const crmDelivery: Feature = {
  ...
  howItHelps: "Recovered records drop straight into HubSpot, Salesforce, Pipedrive, Klaviyo — and into your retargeting audiences. Consent Resolve is an input to the marketing machine you already run, not another tool to manage.",
  ...
  faq: {
    headline: "What buyers ask about CRM delivery.",
    items: [
      { q: "Which CRMs do you connect to?",          a: "HubSpot, Salesforce, Pipedrive, Klaviyo, and others — ask us about yours." },
...
const multiChannelFollowUp: Feature = {
  ...
  howItHelps: "Recovered visitors flow into your retargeting, your email sequences, and your CRM all at once — so the visitor sees your message on the next ad they scroll, the next email they open, and the next time they search. The funnel does the work; the inbound shows up.",
  illustration: "/illustrations/features/15-multi-channel.svg",
  subhead: "Recovered records flow into every funnel surface you run — retargeting, email, SMS, CRM — so the visitor is touched wherever they're easiest to re-engage.",
  aeoAnswer:
    "Multi-Channel Follow-Up pipes each identified lead into every funnel channel you run — retargeting audiences, email sequences, SMS, and your CRM. Because Consent Resolve delivers full contact details with consent, your existing automations can re-engage the visitor wherever they spend their attention — and the inbound comes in warm.",
  problem: {
    headline: "One funnel surface shouldn't decide whether they come back.",
    body: "If retargeting is your only re-engagement move, every visitor who doesn't scroll past your ad is a lost deal. Email-only is no better. People live across surfaces — social, email, SMS, search. The funnels that book more inbound hit every surface, not just one.",
  },
  howItWorks: {
    ...
    steps: [
      ...
      { title: "Inbound lands warm.",    body: "By the time they reach out, they've seen you across surfaces." },
    ],
  },
  benefits: {
    headline: "More surfaces, more inbound.",
    items: [
  ...
  faq: {
    headline: "What buyers ask about multi-channel follow-up.",
    items: [
      ...
      { q: "How does this re-engage someone across channels?", a: "The consented email feeds your email sequences and your retargeting audiences, so the visitor sees you again wherever they pay attention — and comes back to reach out." },
...
const builtInCompliance: Feature = {
  ...
  aeoAnswer:
    "Built-In Compliance records every visitor's consent decision (yes, no, or dismiss) with a timestamp, IP, and user agent, then stores the audit trail for seven years. It's built for the laws that actually hit businesses — TCPA, CIPA, and state privacy laws like the Texas TDPSA — so a recovered lead can always be proven authorized, and a single complaint never becomes a multi-million-dollar event.",
  problem: {
  ...
  faq: {
    headline: "What buyers ask about consent-first tracking.",
    items: [
...
const roiReporting: Feature = {
  ...
  tagline: "Cost-per-deal, not cost-per-lead.",
  howItHelps: "See your recovery spend tied to the deals your funnel closes from recovered visitors. The number that matters — blended cost per deal — drops on the same marketing spend. Marketing you can finally measure.",
  illustration: "/illustrations/features/17-roi-reporting.svg",
  subhead: "See your cost per identified lead against the deals you actually closed — so you know, in plain dollars, that it's paying for itself.",
  aeoAnswer:
    "ROI Reporting shows what your leads cost against the deals you actually closed, in plain dollars. Consent Resolve tracks your cost per identified lead and ties it to closed revenue, so you can see at a glance whether the tool is paying for itself — no spreadsheets, no guesswork, just a clear return number.",
  problem: {
    headline: "You can't tell what's actually making you money.",
    body: "You spend across several channels, and at the end of the month you're guessing which one paid off. Marketing you can't measure is just hoping. If you can't see cost-in versus revenue-out in plain numbers, you're flying blind with your own money.",
  },
  howItWorks: {
    headline: "Cost in, deals out, plain and simple.",
    steps: [
      { title: "We track your cost.",  body: "What you spend per identified lead." },
      { title: "You mark what closed.", body: "Tie leads to the deals you actually won." },
  ...
  benefits: {
    ...
    items: [
      { title: "Real numbers.",        body: "Cost per lead against deals closed, no guessing." },
  ...
  faq: {
    headline: "What buyers ask about ROI reporting.",
    items: [
      { q: "How do you know what I closed?",       a: "You mark which leads turned into deals, and the report ties it to cost." },
      { q: "Can I compare it to my other channels?", a: "Yes — you can see your cost per closed deal side by side with other channels." },
      { q: "Do I need to build spreadsheets?",     a: "No. The numbers are calculated for you." },
      { q: "How fast do I see ROI?",               a: "As soon as you start marking closed deals — often within your first week or two live." },
    ],
  },
...
export const FEATURE_GROUPS: FeatureGroup[] = [
  {
    ...
    blurb:
      "Every recovery, every audience, every lead — starts with the visitor's documented yes. Consent-first tracking is the receipt that keeps the business defensible when a regulator, lawyer, or ad platform asks.",
