/**
 * Canonical homepage FAQ — the single source for BOTH the rendered
 * <FAQSection> and the FAQPage JSON-LD emitted on the homepage. Edit here
 * only; FAQSection.astro and index.astro both import this so the visible
 * answers and the structured-data answers can never drift apart.
 */
...
export const HOMEPAGE_FAQS: HomepageFaq[] = [
  ...
  {
    question: "How fast does a lead reach me?",
    answer: "Seconds. A Slack, text, or email fires the moment they consent, and it lands in your CRM at the same time.",
  },
  {
