...
export const INDUSTRIES: Industry[] = [
  {
    ...
    heroSubhead: "Big projects get researched for weeks before a homeowner picks up the phone. See who's pricing a remodel or addition on your site, recover the bounce when they consent, and follow up before three other GCs do.",
  ...
  },
  {
    ...
    heroSubhead: "Handyman work runs on volume and speed. See the homeowners shopping your site for a to-do list, recover the bounce when they consent, and book the work before they call the next guy.",
  ...
  },
  {
    ...
    heroSubhead: "A leaning tree or a storm-snapped limb is a \"today\" problem. See who's pricing removal in your area, recover the bounce when they consent, and reach out before the cleanup crews roll in.",
  ...
  },
  {
    ...
    heroSubhead: "Electrical work gets researched before it gets booked. See who's pricing a panel upgrade or EV charger on your site, recover the bounce when they consent, and follow up while it's top of mind.",
  ...
  },
  {
    ...
    heroSubhead: "Deck and fence projects are seasonal and quote-driven. See who's pricing a build on your site, recover the bounce when they consent, and get your bid in before the season fills up.",
  ...
  },
  {
    ...
    heroSubhead: "Curb-appeal jobs are easy to say yes to and easy to book. See who's pricing a driveway or house wash on your site, recover the bounce when they consent, and quote them first.",
  ...
  },
  {
    ...
    heroSubhead: "Your whole pitch is convenience — you come to them. See who's shopping your site for mobile repair or detailing, recover the bounce when they consent, and book the driveway visit first.",
