...
window.DATA = {
  ...
  conversations: [
    ...
    { id:"c08", bucket:"open", source:"meta", channel:"sms", name:"Sandra Cole", company:"Cole & Sons Painting",
      ...
      task:{ tag:"wait", text:"Auto-text failed (landline). Email her, or call (727) 202-5996.", cta:"Switch to email" },
    ...
    { id:"c06", bucket:"auto", source:"meta", channel:"ai_call", name:"Gloria Bennett", company:"Bennett Home Services",
      ...
      messages:[
        ...
        { dir:"out", channel:"ai_call", body:"AI call placed (23s). AMD: voicemail. VM left: “Hi Gloria, this is the Consent Resolve team — this is an AI assistant — call or text us at (727) 202-5996.”", ts:"18 min ago", meta:"voicemail" } ] },
