...
return '<div class="card" style="padding:12px;margin-bottom:12px"><div class="muted tiny" style="margin-bottom:6px">Profile</div>'+body+'<div style="margin-top:8px"><button class="ghost" id="ibEnrich" data-cid="'+esc(contact.id)+'">'+(enr?"Re-enrich":"Enrich with Apollo")+'</button> <button class="ghost" id="ibSetCo" data-cid="'+esc(contact.id)+'" style="margin-left:6px">Set company</button> <span class="muted tiny" id="ibEnrichMsg"></span></div></div>';}
