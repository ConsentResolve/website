...
var head='<div style="margin-bottom:12px"><div style="font-weight:600">'+esc(who)+'</div><div class="muted tiny" style="margin-top:3px">'+chBadge(c.channel)+' '+esc(c.primary_email||"")+(c.company_name?(" · "+esc(c.company_name)):"")+'</div><div class="tiny" id="presBox" style="margin-top:4px;color:#7ff0cd"></div></div>';
...
box.innerHTML=head+profilePanel(d.contact,d.company)+actions+'<div class="tl">'+msgs+'</div>'+composer+notesBlock;
