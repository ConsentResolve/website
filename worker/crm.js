...
var composer=(c.channel==="email"||c.channel==="instantly")?'<div style="margin-top:14px"><textarea id="ibReply" rows="3" placeholder="Reply to '+esc(who)+(c.channel==="instantly"?" (via Instantly)":"")+'…" style="width:100%"></textarea><div style="margin-top:8px"><button class="btn" id="ibSend">Send</button> <span class="muted tiny" id="ibSendMsg"></span></div></div>':"";
