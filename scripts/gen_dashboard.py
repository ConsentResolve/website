...
.dot{width:11px;height:11px;border-radius:50%;display:inline-block;flex:none}.dot.green{background:#00e5a0;box-shadow:0 0 8px #00e5a080}.dot.red{background:#ff8d8d;box-shadow:0 0 8px #ff8d8d80}.dot.grey{background:#475569}
