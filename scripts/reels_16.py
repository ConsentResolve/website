...
"02": {"avatar":"aaron","title":"Invoice Shredder","hook":"One lead. Sold to four of you.","scenes":[
 (0,3,"HOOK","hookcard",None,"Okay, you ever buy an exclusive lead... and then find out three other guys already called that same person? Yeah. Let me show you why.","One lead. Sold to four of you."),
 (3,6,"ASSET","invoice","a paper invoice icon stamped 'shared lead, sold to 4' held above a paper shredder","So this right here? This is what one shared lead actually costs you.","sold 4 ways"),
 (6,9,"ASSET","shred","an invoice icon feeding into a shredder, strips falling","You drop a hundred bucks on it. And it gets sold to four of you. First one to call wins.",""),
 (9,13,"AVATAR",None,None,"So here's what we built instead. And honestly? It's stupid simple.",""),
 (13,16,"AVATAR",None,None,"You keep your ads. Same traffic coming in. You don't change a thing.","keep your ads"),
 (16,20,"ASSET","leadcard",None,"Somebody lands on your site, taps Accept on your consent banner. And boom. You've got their real email.","real email"),
 (20,23,"AVATAR",None,None,"And you're never cold-calling anybody. They just come back and call you.","warm inbound"),
 (23,26,"ASSET","tag","a price tag icon reading '$7 yours alone'","And the best part? It's yours. Just yours. Never resold to some other guy.","yours alone"),
 (26,30,"ASSET","code","a code editor window icon with one line highlighted","Seven bucks a lead. Flat. One line of code, cancel whenever. That's it.","$7/lead · "+CTA),
]},
