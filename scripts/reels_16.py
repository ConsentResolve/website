...
"02": {"avatar":"aaron","title":"Invoice Shredder","scenes":[
 (0,2,"ASSET","invoice","a paper invoice icon stamped 'shared lead, sold to 4' held above a paper shredder","This is what one lead costs you. Watch.","sold 4 ways"),
 (2,5,"ASSET","shred","an invoice icon feeding into a shredder, strips falling","Sold to four of you. Whoever calls first wins. That's the model.",""),
 (5,8,"AVATAR",None,None,"Here's what we built instead. Ten-minute setup.",""),
 (8,12,"AVATAR",None,None,"Keep your ads. Same traffic up top. Change nothing.","keep your ads"),
 (12,16,"ASSET","intact","a clean intact lead card icon sliding up out of a shredder tray","When a homeowner accepts your consent banner, you get a real email.","real name + email"),
 (16,20,"AVATAR",None,None,"You never call cold. They come back and call you. Warm.","warm inbound"),
 (20,24,"ASSET","tag","a price tag icon reading '$7 yours alone'","And it's yours. Not resold. One consent, one contractor, you.","yours alone"),
 (24,29,"SPLIT","code","a code editor window icon with one line highlighted","Seven dollars a lead. Flat. Cancel anytime. One line of code.","$7/lead · "+CTA),
]},
...
"10": {"avatar":"leah","title":"Gray to Green","scenes":[
 ...
 (25,29,"ASSET","a5-phone","a person icon linked by a connecting line to a ringing telephone, a friendly callback","Consent calls you back.",""),
]},
