...
_RAW = [
 ...
 ("mktg", "Thumbtack is the friend that introduces its friends to four people at one time. And still asks for forty bucks."),
 ("mktg", "The Google algorithm is a teacher who changes the rules and won't tell you which one you broke."),
